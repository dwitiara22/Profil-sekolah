...
class BengkelController extends Controller
{
 public function index()
   ...
   public function update(Request $request, TimKerja $bengkel)
    {
        // 1. Validasi Input
        $request->validate([
            'nama_lengkap' => 'required|string|max:255',
    ...
    public function destroy(TimKerja $bengkel)
    {
        if($bengkel->foto) {
            Storage::disk('public')->delete($bengkel->foto);
        }
