...
class KeuanganController extends Controller
{
   ...
   public function update(Request $request, TimKerja $keuangan)
    {
        // 1. Validasi Input
        $request->validate([
            'nama_lengkap' => 'required|string|max:255',
    ...
    public function destroy(TimKerja $keuangan)
    {
        if($keuangan->foto) {
            Storage::disk('public')->delete($keuangan->foto);
        }
