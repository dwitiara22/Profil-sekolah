...
<div class="bg-gray-100 min-h-screen p-8">
    ...
    <div class="bg-white rounded-3xl shadow-sm p-8 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div class="flex flex-col items-center text-center w-full md:w-44 shrink-0">
            ...
            <div class="w-32 h-48 bg-gray-200 rounded-2xl overflow-hidden shadow-lg border-2 border-indigo-600 flex items-center justify-center relative group">
                <!-- Ganti src dengan path file foto Kaproka APAPL Anda -->
                <img src="path-to-foto-kaproka-apapl.jpg" 
                     alt="Foto Kaproka APAPL" 
        ...
        <div>
            ...
            <p class="text-gray-500 mt-4 leading-relaxed max-w-3xl">
                Program keahlian APAPL berfokus pada teknik pembenihan, pembesaran, 
                manajemen pakan, pengelolaan lingkungan, serta analisis usaha budidaya komoditas 
                perikanan air payau dan laut bernilai ekonomis tinggi bagi siswa/i.
            </p>
    ...
    <div class="mt-10">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Tim Pengajar APAPL</h2>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="p-5 text-sm font-medium text-gray-800 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-xs">DR</div>
                                Dewi Lestari, S.Pi.
                            </td>
                            <td class="p-5 text-sm text-gray-500 font-mono">199205202018012004</td>
                            <td class="p-5 text-sm text-gray-600">Kultur Pakan Alami</td>
    ...
    <div class="mt-16">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Data Siswa/i APAPL</h2>
                <p class="text-gray-500 mt-2">Daftar siswa/i aktif Program Keahlian APAPL.</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="p-5 text-sm font-medium text-gray-800 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold text-xs">AM</div>
                                Ahmad Mudzakir
                            </td>
                            <td class="p-5 text-sm text-gray-500 font-mono">0065544332</td>
                            <td class="p-5 text-sm text-gray-600">X APAPL 1</td>
