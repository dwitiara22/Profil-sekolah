    ...
    <div class="bg-white rounded-3xl shadow-sm p-8 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div class="flex flex-col items-center text-center w-full md:w-44 shrink-0">
            ...
            <div class="w-32 h-48 bg-gray-200 rounded-2xl overflow-hidden shadow-lg border-2 border-indigo-600 flex items-center justify-center relative group">
                <!-- Ganti src dengan path file foto Kaproka APHP Anda -->
                <img src="path-to-foto-kaproka-aphp.jpg" 
                     alt="Foto Kaproka APHP" 
        ...
        <div>
            ...
            <p class="text-gray-500 mt-4 leading-relaxed max-w-3xl">
                Program keahlian APHP berfokus pada kompetensi pengolahan produk perikanan 
                modern dan tradisional, pengawasan mutu pangan (HACCP), teknik pengemasan, 
                serta manajemen kewirausahaan berbasis komoditas hasil perikanan.
            </p>
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-500 mt-2">
                    Personel yang berdedikasi melayani administrasi program keahlian.
                </p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="p-5 text-sm text-gray-500 font-mono">199002142015031002</td>
                            <td class="p-5 text-sm text-gray-600">Produksi Olahan Diversifikasi</td>
    ...
    <div class="mt-16">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-500 mt-2">
                    Daftar siswa/i aktif Program Keahlian APHP.
                </p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="p-5 text-sm text-gray-500 font-mono">0061234567</td>
                            <td class="p-5 text-sm text-gray-600">XII APHP 1</td>
