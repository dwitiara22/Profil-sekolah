    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10 mb-10 overflow-hidden relative">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-center relative z-10">
                <div class="w-full md:w-1/3 text-center">
                    <!-- Icon Kepegawaian -->
                    <div class="w-40 h-40 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 border-8 border-indigo-50 shadow-xl -rotate-2 transform transition-transform hover:rotate-0">
                ...
                <div class="w-full md:w-2/3">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full uppercase tracking-wider">HR & Administration</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-[#163C67] tracking-tight mb-4">
                        Unit Layanan <span class="text-indigo-600">Kepegawaian</span>
                    </h1>
                    <p class="text-gray-600 leading-relaxed text-justify text-lg">
                        Berkomitmen dalam mengelola manajemen sumber daya manusia yang transparan dan akuntabel. Kami berfokus pada pengembangan karier, administrasi kepangkatan, serta kesejahteraan seluruh staf dan pengajar untuk menciptakan lingkungan kerja yang produktif, harmonis, dan profesional.
                    </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Total Personel</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor font-bold"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">100%</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Digitalisasi Arsip</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-teal-50 text-teal-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor font-bold"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">24</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Program Pelatihan</p>
            </div>
            <div class="bg-indigo-700 p-6 rounded-2xl text-white shadow-lg flex flex-col items-center text-center">
                ...
                <h4 class="text-xl font-bold uppercase">Integritas</h4>
                <p class="text-indigo-200 text-xs font-bold uppercase tracking-widest">Motto Layanan</p>
            </div>
        </div>

        <!-- Section Header Tim Kepegawaian -->
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-900">Staf Pengelola Kepegawaian</h2>
                <p class="text-gray-500 mt-1">Personel yang berdedikasi melayani administrasi dan pembinaan SDM.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full py-24 text-center bg-white rounded-[2rem] border-4 border-dashed border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-400">Belum ada data staf kepegawaian</h3>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-indigo-700">Tambah Anggota Tim</h3>
                    ...
                    <form action="{{ route('timja.rtp.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-black text-gray-400 uppercase mb-2">Jabatan Struktur</label>
                        ...
                        <div>
                            <label class="block text-xs font-black text-gray-400 uppercase mb-2">Foto Pegawai</label>
                        ...
                        <button type="submit" class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 mt-4 uppercase">Simpan Data Pegawai</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div id="modal-edit" class="hidden fixed inset-0 z-[60] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-indigo-700">Update Data Pegawai</h3>
        ...
        <div id="modal-delete" class="hidden fixed inset-0 z-[70] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-sm p-8 text-center shadow-2xl">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Hapus Pegawai?</h3>
                    <p class="text-gray-500 mb-8 text-sm">Tindakan ini tidak dapat dibatalkan. Data akan dihapus dari database.</p>
