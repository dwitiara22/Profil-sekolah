    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10 mb-10 overflow-hidden relative">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-center relative z-10">
                <div class="w-full md:w-1/3 text-center">
                    <!-- Icon Pengolahan -->
                    <div class="w-40 h-40 bg-amber-600 rounded-2xl flex items-center justify-center mx-auto mb-4 border-8 border-amber-50 shadow-xl -rotate-3 transform transition-transform hover:rotate-0">
                ...
                <div class="w-full md:w-2/3">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="px-3 py-1 bg-amber-100 text-amber-700 text-xs font-bold rounded-full uppercase tracking-wider">Product Innovation & Quality Control</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-[#163C67] tracking-tight mb-4">
                        Unit Layanan <span class="text-amber-600">Pengolahan</span>
                    </h1>
                    <p class="text-gray-600 leading-relaxed text-justify text-lg">
                        Pusat hilirisasi dan nilai tambah produk perikanan. Kami berfokus pada pengembangan produk olahan inovatif dengan standar keamanan pangan (HACCP). Unit ini merupakan inkubator bisnis bagi mahasiswa untuk menciptakan produk bernilai ekonomis tinggi sekaligus menjamin ketersediaan pangan olahan yang sehat bagi masyarakat.
                    </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-amber-50 text-amber-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">25+</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Jenis Produk Olahan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-orange-50 text-orange-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">1 Ton+</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Kapasitas Produksi/Bulan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 class="text-2xl font-bold text-gray-800">Partner</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">UMKM Binaan</p>
            </div>
            <div class="bg-amber-700 p-6 rounded-2xl text-white shadow-lg flex flex-col items-center text-center">
                ...
                <h4 class="text-xl font-bold uppercase">Hygienic</h4>
                <p class="text-amber-200 text-xs font-bold uppercase tracking-widest">Standar Mutu</p>
            </div>
        </div>

        <!-- Section Header Tim Pengolahan -->
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-900">Tim Teknis Pengolahan</h2>
                <p class="text-gray-500 mt-1">Pakar pengolahan hasil perikanan dan teknologi pangan.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full py-24 text-center bg-white rounded-[2rem] border-4 border-dashed border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-400">Belum ada data tim teknis pengolahan</h3>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-amber-700">Tambah Anggota Tim</h3>
                    ...
                    <form action="{{ route('timja.rtp.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-black text-gray-400 uppercase mb-2">Jabatan (e.g. Quality Control)</label>
        ...
        <div id="modal-delete" class="hidden fixed inset-0 z-[70] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-sm p-8 text-center shadow-2xl">
                    ...
                    <p class="text-gray-500 mb-8 text-sm">Tindakan ini akan menghapus data personel pengolahan dari sistem.</p>
