    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-center relative z-10">
                ...
                <div class="w-full md:w-2/3">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full uppercase tracking-wider">Household & Facilities</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-[#163C67] tracking-tight mb-4">
                        Unit Rumah Tangga & <span class="text-emerald-600">Perlengkapan</span>
                    </h1>
                    <p class="text-gray-600 leading-relaxed text-justify text-lg">
                        Garda terdepan dalam pengelolaan fasilitas dan kenyamanan lingkungan kerja. Unit RTP bertanggung jawab penuh atas pemeliharaan sarana prasarana, manajemen inventaris aset, serta pengadaan perlengkapan operasional. Kami berkomitmen menciptakan ekosistem kerja yang kondusif, aman, dan tertata demi mendukung produktivitas seluruh civitas kerja secara maksimal.
                    </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">100%</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Kesiapan Sarana</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 class="text-2xl font-bold text-gray-800">Terdata</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Inventaris Aset</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">24/7</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Layanan Teknis</p>
            </div>
            <div class="bg-emerald-600 p-6 rounded-2xl text-white shadow-lg flex flex-col items-center text-center">
                ...
                <h4 class="text-xl font-bold uppercase">Terjamin</h4>
                <p class="text-emerald-100 text-xs font-bold uppercase tracking-widest">Kualitas Fasilitas</p>
            </div>
        </div>

        <!-- Section Header Tim RTP -->
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-900">Personel RTP</h2>
                <p class="text-gray-500 mt-1">Tim pengelola aset, teknisi, dan administrasi perlengkapan.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full py-24 text-center bg-white rounded-[2rem] border-4 border-dashed border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-400">Belum ada data tim RTP</h3>
                <p class="text-gray-400 text-sm">Klik tombol tambah untuk mengisi daftar personel RTP.</p>
            </div>
            @endforelse
        </div>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-emerald-700">Tambah Anggota RTP</h3>
                    ...
                    <form action="{{ route('timja.rtp.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-black text-gray-400 uppercase mb-2">Jabatan (e.g. Staf Perlengkapan)</label>
                        ...
                        <div>
                            ...
                            <input type="file" name="foto" class="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100">
                        </div>
                        <button type="submit" class="w-full py-4 bg-emerald-600 text-white rounded-2xl font-bold hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100 mt-4 uppercase">Simpan Data Tim</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div id="modal-edit" class="hidden fixed inset-0 z-[60] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-emerald-700">Update Data Tim</h3>
        ...
        <div id="modal-delete" class="hidden fixed inset-0 z-[70] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-sm p-8 text-center shadow-2xl">
                    ...
                    <p class="text-gray-500 mb-8 text-sm">Tindakan ini akan menghapus data personel RTP dari sistem.</p>
