            ...
            <div class="flex flex-col md:flex-row gap-8 items-center relative z-10">
                ...
                <div class="w-full md:w-2/3">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full uppercase tracking-wider">Aquaculture & Production</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-[#163C67] tracking-tight mb-4">
                        Unit Layanan <span class="text-emerald-600">Tambak</span>
                    </h1>
                    <p class="text-gray-600 leading-relaxed text-justify text-lg">
                        Pusat keunggulan budidaya perikanan berkelanjutan. Unit Tambak berfokus pada pengelolaan ekosistem budidaya yang optimal, penerapan teknologi akuakultur modern, serta peningkatan produktivitas hasil laut. Kami berdedikasi untuk menciptakan standar operasional tambak yang ramah lingkungan dan berdaya saing tinggi bagi kemandirian pangan nasional.
                    </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">24+</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Petak Tambak Aktif</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                <div class="w-12 h-12 bg-teal-50 text-teal-600 rounded-full flex items-center justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" font-bold><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                </div>
                <h4 class="text-2xl font-bold text-gray-800">15 Ton</h4>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Produksi / Siklus</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Standar Bio-Security</p>
            </div>
            <div class="bg-emerald-700 p-6 rounded-2xl text-white shadow-lg flex flex-col items-center text-center">
                ...
                <p class="text-emerald-200 text-xs font-bold uppercase tracking-widest">Sistem Budidaya</p>
            </div>
        </div>

        <!-- Section Header Tim Tambak -->
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-900">Tim Operasional Tambak</h2>
                <p class="text-gray-500 mt-1">Tenaga ahli dan teknisi lapangan profesional.</p>
            </div>
            ...
            <button onclick="openModal('modal-form')"
                ...
                Tambah Anggota Tambak
            </button>
            @endauth
        </div>

        <!-- Grid Data Tim Tambak -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full py-24 text-center bg-white rounded-[2rem] border-4 border-dashed border-gray-100">
                <div class="w-20 h-20 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                </div>
                <h3 class="text-xl font-bold text-gray-400">Belum ada data tim Tambak</h3>
                <p class="text-gray-400 text-sm">Klik tombol tambah untuk mengisi daftar personel lapangan.</p>
            </div>
            @endforelse
        </div>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-emerald-700">Tambah Anggota Tambak</h3>
                    ...
                    <form action="{{ route('timja.rtp.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-black text-gray-400 uppercase mb-2">Jabatan (e.g. Teknisi Tambak)</label>
        ...
        <div id="modal-delete" class="hidden fixed inset-0 z-[70] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-3xl w-full max-w-sm p-8 text-center shadow-2xl">
                    ...
                    <p class="text-gray-500 mb-8 text-sm">Tindakan ini akan menghapus data personel tambak dari sistem.</p>
